...
/** Конкретный классс создатель (реализация абстрактного класса создателя).
 ...
 * Текстовые файл лежать в одной директории. Пример. Names.txt, Address.txt - файлы в системе.
